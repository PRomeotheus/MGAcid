...
public:
    ...
    // Opens the device. Safe to call more than once; honours MGA_NO_AUDIO.
    void initialize();
    void shutdown();
    ...
    // output is scaled; MGA_AUDIO_DUMP keeps the game's own levels.
    ...
    // Whether a playback device is open (not with MGA_NO_AUDIO, or when
