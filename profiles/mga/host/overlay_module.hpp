...
#if defined(MGA_OVERLAY_MODULE)
#if defined(_WIN32)
#define MGA_OVERLAY_EXPORT __declspec(dllexport)
#else
#define MGA_OVERLAY_EXPORT __attribute__((visibility("default")))
#endif
#else
#define MGA_OVERLAY_EXPORT
#endif

extern "C" {
MGA_OVERLAY_EXPORT const mga::OverlayModuleInfo *mga_overlay_info();
MGA_OVERLAY_EXPORT void mga_register_overlay(psprecomp::Runtime &runtime);
}
