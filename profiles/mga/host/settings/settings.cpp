...
const std::vector<Field> &fields() {
    static const std::vector<Field> table = {
        {"video.internal_scale", "MGA_INTERNAL_SCALE",
        ...
        {"video.texture_scale", "MGA_TEXTURE_SCALE",
         ...
         [](Settings &s, const char *t) { (void)parse_uint(t, 1u, kMaxTextureScale, s.texture_scale); }},
        ...
        {"video.post_process", "MGA_POST_PROCESS",
         ...
         [](Settings &s, const char *t) { s.post_process = variable_flag(t); }},
        {"video.fxaa", "MGA_FXAA",
         [](Settings &s, const std::string &t) { return parse_bool(t, s.fxaa); },
         [](const Settings &s) { return std::string(s.fxaa ? "1" : "0"); },
         [](Settings &s, const char *t) { s.fxaa = variable_flag(t); }},
        {"video.contact_shadows", "MGA_CONTACT_SHADOWS",
         [](Settings &s, const std::string &t) { return parse_float(t, 0.0f, 1.0f, s.contact_shadows); },
         [](const Settings &s) { return format_float(s.contact_shadows); },
         [](Settings &s, const char *t) { (void)parse_float(t, 0.0f, 1.0f, s.contact_shadows); }},
        {"video.blob_shadows", "MGA_BLOB_SHADOWS",
         [](Settings &s, const std::string &t) { return parse_float(t, 0.0f, 1.0f, s.blob_shadows); },
         [](const Settings &s) { return format_float(s.blob_shadows); },
         [](Settings &s, const char *t) { (void)parse_float(t, 0.0f, 1.0f, s.blob_shadows); }},
        ...
        {"video.shadow_maps", "MGA_SHADOW_MAPS",
         ...
         [](Settings &s, const char *t) { (void)parse_float(t, 0.0f, 1.0f, s.shadow_maps); }},
        {"video.texture_pack", "MGA_TEXTURE_PACK",
        ...
        {"video.colour_grade", "MGA_COLOUR_GRADE",
         ...
         [](Settings &s, const char *t) { (void)parse_float(t, 0.0f, 1.0f, s.colour_grade); }},
        {"video.smart_2d", "MGA_SMART_2D",
         ...
         [](Settings &s, const char *t) { s.smart_2d = variable_flag(t); }},
        ...
        {"input.dead_zone", "MGA_PAD_DEADZONE",
        ...
        {"input.right_stick", "MGA_PAD_RSTICK_DPAD",
        ...
        {"input.right_stick_zone", "MGA_PAD_RSTICK_ZONE",
        ...
        {"input.name_entry", "MGA_OSK_MODE",
         ...
         [](Settings &s, const char *t) {
             if (!kNameEntries.parse(t, s.name_entry)) std::cerr << "[settings] MGA_OSK_MODE: keyboard or fixed\n";
         }},
        {"input.name", "MGA_OSK_TEXT",
         [](Settings &s, const std::string &t) {
        ...
        {"ui.menu_pause_multiplayer", "MGA_MENU_PAUSE_MULTIPLAYER",
        ...
        {"network.recent", nullptr,
         ...
         nullptr},
        {"network.host_port", "MGA_ADHOC_HOST_PORT",
...
void load(State &s) {
    ...
    // MGA_OSK_MODE says otherwise.
    if (s.overrides.count("input.name_entry") == 0u && std::getenv("MGA_OSK_TEXT") != nullptr) {
