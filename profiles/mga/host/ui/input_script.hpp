...
// MGA_INPUT_SCRIPT: scripted input for testing the interface without a
// person at the controls, the way MGA_AUTO_CONFIRM walks through the game.
//
...
//   shot NAME         write the window image to MGA_SCREENSHOT_DIR/NAME.bmp
//   quit              close the window
//
// For example: MGA_INPUT_SCRIPT="300:key Escape;330:shot menu;360:pad leftstick+rightstick"
//
// MGA_INPUT_LIVE names a file read while the game runs: each line appended
